package com.grameenphone.wipro.utility.security;
...
public class CryptoUtil {
	public static X509Certificate loadCertificate(String plainText) throws CertificateException {
		CertificateFactory certificateFactory = CertificateFactory.getInstance("X509");
		return (X509Certificate)certificateFactory.generateCertificate(new ByteArrayInputStream(plainText.getBytes()));
	}
	...
	public static String macHash(String algorithm, String src, String base64Key) throws NoSuchAlgorithmException, InvalidKeyException {
		...
		return Hex.encodeHexString(mac.doFinal(src.getBytes()));
	}
	...
	public static String hash(String algorithm, String plainText) throws NoSuchAlgorithmException {
		return Hex.encodeHexString(MessageDigest.getInstance(algorithm).digest(plainText.getBytes(StandardCharsets.UTF_8)));
	}
}